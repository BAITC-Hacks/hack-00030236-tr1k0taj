...
- STT и роутер без провайдера отдают понятную ошибку, а не случайный результат.
- BaselineExecutor двигает тему и слоты в контексте, чтений не делает; оператор — мок с контекстом.
- TemplateResponder озвучивает ориентир из кита, без LLM.
"""
...
class BaselineExecutor:
    """Минимальный исполнитель: тема, стек, слоты, handoff. Чтения — в боевом app.executor."""
