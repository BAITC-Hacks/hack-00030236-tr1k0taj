...
> Обновление ядра: [agent-kernel.md](agent-kernel.md) и [ADR 0009](../adr/0011-multi-agent-kernel.md)
> заменяют старые ограничения streaming, числа агентов/LLM-вызовов, применения фоновых
> результатов, прерывания и публикации доски. Предметные требования ниже сохраняются.
